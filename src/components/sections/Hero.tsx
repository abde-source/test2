    ...
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <video
          ...
          loop
          playsInline
          poster="https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=1920"
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        >
          <span className="inline-block text-premium-red text-sm uppercase tracking-[0.3em] mb-6">
            Marrakech - Morocco
          </span>
        </motion.div>
        ...
        >
          Premium vehicles. Instant booking. Professional service.
        </motion.p>
      ...
      >
        ...
        >
          <div className="w-1 h-2 bg-premium-red rounded-full" />
        </motion.div>
      </motion.div>
    </section>
  )
